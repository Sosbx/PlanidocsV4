...
import { usePlanningPeriod } from '../../../context/PlanningPeriodContext';
import { useComposableExchangeData } from '../../../hooks/exchange/useComposableExchangeData';
import { useCalendarNavigation } from '../../../hooks/shiftExchange/useCalendarNavigation';
import { addMonths } from 'date-fns';
import Toast from '../../Toast';
import ExchangeModal from '../ExchangeModal';
import ExchangeProposalsModal from '../ExchangeProposalsModal';
import DirectExchangeTable from '../DirectExchangeTable';
import ExchangePageTemplate from '../../shared/exchange/ExchangePageTemplate';
import { useDirectExchangeData } from '../../../hooks/exchange/direct/useDirectExchangeData';
import { useDirectExchangeFilters } from '../../../hooks/exchange/direct/useDirectExchangeFilters';
import { useDirectExchangeModals } from '../../../hooks/exchange/direct/useDirectExchangeModals';
import { useDirectExchangeActions } from '../../../hooks/exchange/direct/useDirectExchangeActions';
import { useDirectProposalActions } from '../../../hooks/exchange/direct/useDirectProposalActions';
...
const DirectExchangeContainer: React.FC = () => {
  ...
  const handleCellClick = async (event: React.MouseEvent, assignment: any, hasIncomingProposals?: boolean, hasUserProposal?: boolean) => {
    ...
    const existingOperationTypes = existingExchanges.map(ex => ex.operationType);
  ...
  const handleProposedShiftClick = useCallback((e: React.MouseEvent, exchange: any) => {
    ...
    let existingOperationTypes: string[] = [];
    
    // Si l'échange a une propriété existingOperationTypes, l'utiliser
    if (exchange.existingOperationTypes && Array.isArray(exchange.existingOperationTypes)) {
      existingOperationTypes = exchange.existingOperationTypes;
    } 
    // Sinon, déterminer les types d'opération en fonction du type d'opération de l'échange
    else {
    ...
    <>
      ...
      {selectedCell && (
        <ExchangeModal
          ...
          existingOperationTypes={selectedCell.existingOperationTypes || []}
