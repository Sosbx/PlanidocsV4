          ...
          <table className="w-full text-[11px]">
            <thead>
              <tr>
                ...
                <th className="w-8 py-1 px-1 text-center font-medium text-gray-500 bg-gray-50">M</th>
                <th className="w-8 py-1 px-1 text-center font-medium text-gray-500 bg-gray-50">AM</th>
                <th className="w-8 py-1 px-1 text-center font-medium text-gray-500 bg-gray-50">S</th>
              </tr>
            </thead>
            <tbody>
              {dates.map(date => {
                        ...
                        <td key={period} className="py-1 px-1 text-center">
                          {assignment && (
                            <span className={`
                              ...
                              ${period === 'M' ? 'bg-amber-50 text-amber-700' :
                                period === 'AM' ? 'bg-sky-50 text-sky-700' :
