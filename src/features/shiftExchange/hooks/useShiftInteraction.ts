...
/**
 * Hook pour gérer les interactions avec les gardes dans la bourse aux gardes
 * @param users Liste des utilisateurs
 * @param conflictStates États des conflits
 * @param setConflictDetails Fonction pour définir les détails des conflits
 * @param setToast Fonction pour afficher des toasts
 * @param bagPhaseConfig Configuration de la phase de la bourse aux gardes
 * @returns Fonctions et états pour gérer les interactions avec les gardes
 */
export const useShiftInteraction = (
  users: User[],
  ...
  }, [user, bagPhaseConfig.phase, users, checkForConflict, processToggleInterest, setConflictDetails, setToast]);
...
export default useShiftInteraction;
