...
const InterestedUserCard: React.FC<InterestedUserCardProps> = ({
  ...
  if (hasConflict) {
    console.log(`🔍 Analyse permutation pour ${interestedUser.lastName?.toUpperCase() || 'Utilisateur'} (${exchange.date}-${exchange.period}):`, {
      hasConflict,
      userAssignment,
      hasValidAssignment,
      isPermutation,
      ...
      <div className="flex items-center">
        ...
        <div className="flex flex-col">
          <span className="text-sm font-medium text-gray-900 leading-tight">
            {interestedUser.lastName?.toUpperCase() || 'Utilisateur'}
            {successRate !== null && (
